...
import uz.icebergsoft.mobilenews.databinding.ViewHolderArticleTopBinding
...
internal class TopArticleItemController(
    ...
    inner class Holder(parent: ViewGroup) :
        BindableViewHolder<Article>(parent, R.layout.view_holder_article_top) {

        private lateinit var article: Article
        private val binding = ViewHolderArticleTopBinding.bind(itemView)
